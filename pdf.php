...
<head>
    ...
    <style>
        * {
        ...
        body {
            font-family: 'Khmer OS Battambang', 'Siemreap', 'Time New Roman', system-ui, sans-serif;
            color: #0f172a;
            padding: 12mm;
            background: #fff;
            font-size: 12px;
        ...
        .daily-section table td:nth-child(2),
        .daily-section table td:nth-child(3),
        .daily-section table td:nth-child(4) {
            ...
            <div class="daily-section">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>តាមរយៈ KHR</td>
                            <td class="text-income" style="text-align:right"><?= formatCurrencyKHR($totals['income']) ?></td>
                            <td class="text-expense" style="text-align:right"><?= formatCurrencyKHR($totals['expense']) ?></td>
                            <td style="text-align:right"><?= formatCurrencyKHR($totals['income'] - $totals['expense']) ?></td>
                        </tr>
                        <tr>
                            <td>តាមរយៈ USD</td>
                            <td class="text-income" style="text-align:right"><?= formatCurrencyUSD($totals['income_usd']) ?></td>
                            <td class="text-expense" style="text-align:right"><?= formatCurrencyUSD($totals['expense_usd']) ?></td>
                            <td style="text-align:right"><?= formatCurrencyUSD($totals['income_usd'] - $totals['expense_usd']) ?></td>
                        </tr>
                        <tr class="daily-total">
                            <td>សរុប</td>
                            <td class="text-income" style="text-align:right"><?= formatCurrencyKHR($totals['income'] + $totals['income_usd'] * 4100) ?></td>
                            <td class="text-expense" style="text-align:right"><?= formatCurrencyKHR($totals['expense'] + $totals['expense_usd'] * 4100) ?></td>
                            <td style="text-align:right"><?= formatCurrencyKHR(($totals['income'] - $totals['expense']) + ($totals['income_usd'] - $totals['expense_usd']) * 4100) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
